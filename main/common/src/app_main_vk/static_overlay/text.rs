...
use crate::{
    app_main_vk::static_overlay::ShaderInitResources, key_overlay_core::key_property::KeyProperty,
};
...
impl TextShader {
    ...
    pub fn new(r: &ShaderInitResources, batch_size: u32) -> Self {
        ...
        let pipeline =
            Self::create_pipeline(device.clone(), render_pass.clone(), screen_size, batch_size);
